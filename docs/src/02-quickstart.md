...
## Launch Irminsul and accept `CAP_NET_RAW`/admin/root privileges
...
Irminsul needs `CAP_NET_RAW`/admin/root privileges to observe Genshin's network traffic and won't work without it.
